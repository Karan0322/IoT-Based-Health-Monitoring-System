...
#include <Adafruit_SSD1306.h>//for i2c
...
WebServer server(80); //port 80 assigned to for communication protocol-http, it is 80 by  default
Adafruit_SSD1306 display(SCREEN_WIDTH, SCREEN_HEIGHT, &Wire, OLED_RESET);
float bodytemperature,BPM,SpO2;

const char* ssid=""; //ssid username = hotspot name
const char* password="87654322";//password = password of hotspot
...
void setup() { 
   ...
   // Start the DS18B20 sensor
    ...
    if (!pox.begin()) {
        ...
        pox.setOnBeatDetectedCallback(InputDetected);
    }
...
void handle_NotFound(){
  ...
  ptr +="<h3>RollNo.: - 20BEC052       20BEC067</h3>";
